		...
		<section className='contact section'>
			...
			<div className='contact__container container grid'>
				<div className='contact__data'>
					...
					<p className='contact__description'>Feel free to get in touch with me. I always try and respond as soon as i can, i am hoping to hear from you.</p>
					...
					<div className='contact__info'>
						<div className='info__item'>
							...
							<div>
								...
								<h4 className='info__desc'>alexoneplus91@gmail.com</h4>
							</div>
						</div>
						...
						<div className='info__item'>
							...
							<div>
								...
								<h4 className='info__desc'>+351 912 345 678</h4>
							</div>
						</div>
					</div>
